...
const menuOptions = computed<MenuOption[]>(() => [
  ...
  { label: () => h(RouterLink, { to: '/tasks' }, { default: () => t('nav.tasks') }), key: '/tasks', icon: renderIcon('M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-5 14H7v-2h7v2zm3-4H7v-2h10v2zm0-4H7V7h10v2z') },
  ...
  { label: () => h(RouterLink, { to: '/monitor-history' }, { default: () => t('nav.monitorHistory') }), key: '/monitor-history', icon: renderIcon('M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z') },
