...
def notify_healing_success(runtime_context: RuntimeContext, result: HealResult) -> None:
    try:
        ...
        runtime_context.logger.exception("Failed to send Telegram notification for healing success.")
...
def notify_healing_failure(
    ...
    try:
        ...
        runtime_context.logger.exception("Failed to send Telegram notification for healing failure.")
