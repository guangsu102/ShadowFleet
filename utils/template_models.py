...
AssetProvider = Literal["aws", "azure", "digitalocean", "kamatera", "oci", "vultr", "self_hosted"]
...
PROTOCOL_CAPABILITIES: dict[ProtocolType, V2bxProtocolCapabilities] = {
    "AnyTLS": V2bxProtocolCapabilities(
        ...
        supported_asset_providers=("aws", "azure", "digitalocean", "kamatera", "oci", "vultr", "self_hosted"),
        enable_tfo=False,
