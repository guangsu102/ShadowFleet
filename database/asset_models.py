...
AssetType = Literal["aws", "azure", "digitalocean", "gcp", "kamatera", "oci", "vultr", "self_hosted"]
...
GCP_SUPPORTED_PROTOCOLS: set[ProtocolType] = {
    "AnyTLS",
    "Trojan",
    "vless",
    "vmess",
}
VULTR_SUPPORTED_PROTOCOLS: set[ProtocolType] = {
    "AnyTLS",
    "Trojan",
    "vless",
    "vmess",
...
OCI_SUPPORTED_PROTOCOLS: set[ProtocolType] = {
    "AnyTLS",
    "Trojan",
    "vless",
    "vmess",
